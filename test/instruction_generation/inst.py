...
### Generates load instructions for GCN-Accelerator
    ...
    def load(self, id = 'col', sram_offset = 0, dram_offset = 0, xsize = 0, ysize = 0, final_load = 0, denGroup = 0):
        ...
        inst = inst + binary_repr(denGroup, 10)[::-1]
        inst = inst + '0'*(256-len(inst))
        return inst

    def spMM(self, sram_offset_col = 0, sram_offset_ptr = 0, sram_offset_den = 0, sram_offset_val = 0, den_size = 0, col_size = 0, row_size = 0, pr_valid = 0, sram_offset_partial_sum = 0, add_partial_sum = 0, scratchpad_n_global_buffer = 0, nnz_per_group = 0, dense_loaded = 0):
        op = '10'
        ...
        inst = inst + binary_repr(nnz_per_group, 26)[::-1]
